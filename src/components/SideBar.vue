<template>
  <template v-if="isAuthenticated">
    ...
    <aside id="default-sidebar"
      class="shadow-2xl fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0"
      aria-label="Sidebar">
      <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50">
        ...
        <ul class="space-y-2 font-medium">
          <li @click="toggleSidebar">
            <router-link to="/dashboard" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-amber-50 group">
          ...
          <li @click="toggleSidebar">
            <router-link to="/posts" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-amber-50 group">
              <svg class="w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900" fill="currentColor"
                ...
                x="0px" y="0px" viewBox="0 0 122.88 119.31" style="enable-background:new 0 0 122.88 119.31"
                xml:space="preserve">
                <g>
                  <path
          ...
          <li @click="toggleSidebar">
            <router-link to="/profile/me" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-amber-50 group">
              <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900"
